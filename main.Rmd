...
```{r, echo = FALSE}
ggplot(cleaned_data_grouped, aes(x = year, y = total_amount, group = 1)) +
  geom_line(color = "brown4", size = 1.5) +
  theme_calc() +
  ...
  theme(axis.text = element_text(size = 9), axis.title = element_text(size = 12), plot.title = element_text(hjust = 0.5)) +
  annotate("text", x = "'13-14", y = 400, label = "Lost Non-Profit Status")
```
